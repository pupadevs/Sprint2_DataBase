...
select grado.nombre as nombre_grado, asignatura.tipo as tipo_asignatura, SUM(asignatura.creditos) as creditos from grado left join asignatura on grado.id = asignatura.id_grado group by grado.nombre, asignatura.tipo;
